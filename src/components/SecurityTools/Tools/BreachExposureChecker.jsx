    ...
    <div className="sec-tool-page">
      <div className="sec-tool-page-container">
        ...
        <div className="sec-tool-page-header">
          <h1 className="sec-tool-page-title">Breach Exposure Checker</h1>
          <p className="sec-tool-page-subtitle">Check if your password has been exposed in data breaches</p>
        </div>
